...
<!-- Generated: 2026-07-19T13:53:23Z -->
...
| `anthropic-claude-bots` | Anthropic | drop | verified-drop | ok | 20 | 0 |
...
| `openai-chatgpt-user` | OpenAI | drop | verified-drop | ok | 250 | 0 |
...
| `perplexitybot` | Perplexity | drop | verified-drop | ok | 8 | 0 |
| `petalbot-ai-watch` | Huawei | log-only | static-watch | ok | 0 | 0 |
